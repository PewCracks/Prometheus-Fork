local Ast, utils = require("PrometheusFork.ast"), require("PrometheusFork.util")
...
local memeStrings = {
    "gl require('PrometheusFork.Obfuscator')",
    "https://PrometheusFork.replit.app",
    "discord.gg/PrometheusFork",
    "User319183 was here!",
    "PrometheusFork IS THE STRONGEST LUA OBFUSCATOR!",
    "English or spanish?",
    "I love PrometheusFork!",
    "I am a bot",
    "I am a human",
    "I am a cat",
    "I am a dog",
