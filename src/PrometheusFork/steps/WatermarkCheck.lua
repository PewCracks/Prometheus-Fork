...
local Watermark = require("PrometheusFork.steps.Watermark")
local EncryptStrings = require("PrometheusFork.steps.EncryptStrings")
local wrapInFunctionStep = require("PrometheusFork.steps.WrapInFunction")
...
WatermarkCheck.SettingsDescriptor = {
  Content = {
    ...
    type = "string",
    default =
    "This script is safeguarded by PrometheusFork, an advanced Lua obfuscation technology devised by User319183."
  },
}
...
function WatermarkCheck:apply(ast, pipeline)
  ...
  -- Keep the custom variable name as __PrometheusFork__
  self.CustomVariable = "__PrometheusFork__"
